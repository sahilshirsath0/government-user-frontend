...
const GramposhanSwachhataPaniPage = () => { 
  const members = [
    { id: 1, name: 'जयश्री सुभाष कणसे', position: 'अध्यक्ष', mobile: '9975176457' },
    { id: 2, name: 'वर्षा अमोल कणसे', position: 'सचिव', mobile: '8419919920' },
    { id: 3, name: 'तानाजी श्रीरंग सावंत', position: 'सदस्य', mobile: '9881444720' },
    { id: 4, name: 'निलेश पोपट सुतार', position: 'सदस्य', mobile: '7709086564' },
    { id: 5, name: 'जितेंद्र भिमराव मोहिते', position: 'सदस्य', mobile: '9800727500' },
    { id: 6, name: 'गणेश मोहन जरग', position: 'सदस्य', mobile: 'कार्यालय संपर्क' },
    { id: 7, name: 'सुषमा नवनाथ पोळ', position: 'सदस्य', mobile: 'कार्यालय संपर्क' },
    { id: 8, name: 'सुजाता सुरेश कदम', position: 'सदस्य', mobile: 'कार्यालय संपर्क' },
    { id: 9, name: 'मंगल अतुल साळुंखे', position: 'सदस्य', mobile: 'कार्यालय संपर्क' },
    { id: 10, name: 'शशिकला बजरंग सुतार', position: 'सदस्य', mobile: 'कार्यालय संपर्क' },
    { id: 11, name: 'अन्वरबी आलमशाह आतार', position: 'सदस्य', mobile: 'कार्यालय संपर्क' }
  ];
    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <section className="relative h-[60vh] md:h-[70vh] lg:h-[80vh] flex items-center justify-center text-center overflow-hidden">
        ...
        <Image
          ...
          alt="Rural agricultural setting for Gramposhan Swachhata Pani Committee"
          fill
        ...
        <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center p-4 z-10">
          ...
          <h1 className="text-yellow-400 text-2xl xs:text-3xl sm:text-5xl lg:text-7xl font-yatra-one font-bold mb-2 leading-tight typing-animation">
            ग्रामपोषण स्वच्छता व पाणीपुरवठा समिती
          </h1>
      ...
      <div className="container mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8">
        ...
        <div className="text-center mb-6 sm:mb-8 lg:mb-12 animate-fade-in-up">
          ...
          <p className="text-sm xs:text-base sm:text-lg text-gray-600 max-w-4xl mx-auto leading-relaxed font-bakbak-one px-2">
            ग्रामपोषण स्वच्छता व पाणीपुरवठा समिती ही समिती गावातील पोषण, स्वच्छता व पाणीपुरवठा यावर केंद्रित आहे. स्वच्छता मोहिम राबवून गाव स्वच्छ ठेवते. पिण्याच्या पाण्याच्या स्रोतांची निगा राखते. शौचालय निर्माण व वापरास प्रोत्साहन देते. कुपोषण दूर करण्यासाठी पोषण कार्यक्रम राबवते. गावातील सर्वांसाठी स्वच्छ पाणी उपलब्ध करते. आरोग्य तपासणी शिबिरे आयोजित करते. यामुळे गावातील आरोग्य सुधारले आहे.
          </p>
        </div>
          ...
          <div className="flex flex-row justify-center items-center gap-4 sm:gap-6 lg:gap-8 mb-4 sm:mb-6">
            ...
            {sachiv && (
              <div className="w-1/2 sm:w-1/2 lg:w-1/3 bg-white rounded-xl shadow-lg overflow-hidden text-center p-4 sm:p-6 border-t-4 border-cyan-600 hover:shadow-2xl hover:scale-105 hover:-translate-y-2 transition-all duration-300 transform">
                ...
                <div className="text-gray-700 text-sm xs:text-base sm:text-lg font-bakbak-one">
                  <span className="font-semibold">मो.नं.:</span> {sachiv.mobile}
                </div>
              </div>
            )}
          </div>
...
export default GramposhanSwachhataPaniPage;