...
const TantamuktPage = () => { 
  const members = [
    { id: 1, name: 'धनाजी पांडुरंग पाटील', position: 'अध्यक्ष', mobile: 'कार्यालय संपर्क' },
    { id: 2, name: 'तुकाराम पांडुरंग पाटील', position: 'सचिव', mobile: 'कार्यालय संपर्क' },
    { id: 3, name: 'प्रमोद लक्ष्मण उथळे', position: 'सदस्य', mobile: 'कार्यालय संपर्क' },
    { id: 4, name: 'भिमराव भगवान जरग', position: 'सदस्य', mobile: 'कार्यालय संपर्क' },
    { id: 5, name: 'सोपान पांडुरंग मदने', position: 'सदस्य', mobile: 'कार्यालय संपर्क' },
    { id: 6, name: 'नाथा शामराव जरग', position: 'सदस्य', mobile: 'कार्यालय संपर्क' },
    { id: 7, name: 'सुभाष वसंत उथळे', position: 'सदस्य', mobile: 'कार्यालय संपर्क' },
    { id: 8, name: 'रामचंद्र शिवाजी उथळे', position: 'सदस्य', mobile: 'कार्यालय संपर्क' },
    { id: 9, name: 'मधुकर शंकर सावंत', position: 'सदस्य', mobile: 'कार्यालय संपर्क' },
    { id: 10, name: 'निलेश पोपट सुतार', position: 'सदस्य', mobile: '7709086564' },
    { id: 11, name: 'बाबुराव भाऊ चव्हाण', position: 'सदस्य', mobile: 'कार्यालय संपर्क' },
    { id: 12, name: 'वसंत राऊ रसाळ', position: 'सदस्य', mobile: 'कार्यालय संपर्क' },
    { id: 13, name: 'शरद सोपान मदने', position: 'सदस्य', mobile: 'कार्यालय संपर्क' },
    { id: 14, name: 'अन्वरबी आलमशाह आतार', position: 'सदस्य', mobile: 'कार्यालय संपर्क' }
  ];
    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <section className="relative h-[60vh] md:h-[70vh] lg:h-[80vh] flex items-center justify-center text-center overflow-hidden">
        ...
        <Image
          ...
          alt="Rural agricultural setting for Tantamukt Committee"
          fill
      ...
      <div className="container mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8">
        ...
        <div className="mb-8 sm:mb-10 lg:mb-12 animate-slide-in-left delay-200">
          ...
          <div className="flex flex-row justify-center items-center gap-4 sm:gap-6 lg:gap-8 mb-4 sm:mb-6">
            {adhyaksh && (
              <div className="w-1/2 sm:w-1/2 lg:w-1/3 bg-white rounded-xl shadow-lg overflow-hidden text-center p-4 sm:p-6 border-t-4 border-teal-600 hover:shadow-2xl hover:scale-105 hover:-translate-y-2 transition-all duration-300 transform">
                <div className="bg-gradient-to-br from-teal-600 to-teal-800 text-white p-4 rounded-lg mb-4">
                  <div className="text-lg xs:text-xl sm:text-2xl font-bold mb-2 font-yatra-one">{adhyaksh.name}</div>
                  <div className="text-teal-100 text-base xs:text-lg sm:text-xl font-semibold">{adhyaksh.position}</div>
                </div>
            ...
            {sachiv && (
              <div className="w-1/2 sm:w-1/2 lg:w-1/3 bg-white rounded-xl shadow-lg overflow-hidden text-center p-4 sm:p-6 border-t-4 border-cyan-600 hover:shadow-2xl hover:scale-105 hover:-translate-y-2 transition-all duration-300 transform">
                <div className="bg-gradient-to-br from-cyan-600 to-cyan-800 text-white p-4 rounded-lg mb-4">
                  <div className="text-lg xs:text-xl sm:text-2xl font-bold mb-2 font-yatra-one">{sachiv.name}</div>
                  <div className="text-cyan-100 text-base xs:text-lg sm:text-xl font-semibold">{sachiv.position}</div>
                </div>
                <div className="text-gray-700 text-sm xs:text-base sm:text-lg font-bakbak-one">
        ...
        <div className="max-w-4xl mx-auto animate-fade-in-up delay-400">
          ...
          {/* Table Header */}
          <div className="bg-gradient-to-r from-teal-600 to-teal-800 text-white p-3 sm:p-4">
          ...
          <div className="divide-y divide-gray-200">
            {otherMembers.map((member, index) => (
              <div
                ...
                } hover:bg-teal-50 hover:shadow-md hover:scale-[1.01] transition-all duration-300 transform`}
              >
                ...
                <div className="text-xs xs:text-sm sm:text-base text-teal-600 font-bakbak-one text-center font-medium">
                  {member.position}
                </div>
