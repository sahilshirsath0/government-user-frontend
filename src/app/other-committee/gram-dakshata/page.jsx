...
const GramDakshataPage = () => { 
  const members = [
    ...
    { id: 4, name: 'कल्पेश जगन्नाथ रसाळ', position: 'सदस्य', mobile: '9730491369' },
    { id: 5, name: 'अन्वरबी आलमशहा आतार', position: 'सदस्य', mobile: 'कार्यालय संपर्क' },
    { id: 6, name: 'सुजाता सुरेश देवकर', position: 'सदस्य', mobile: 'कार्यालय संपर्क' },
    { id: 7, name: 'कांता तानाजी मदने', position: 'सदस्य', mobile: '9096402240' },
    { id: 8, name: 'वंदना उत्तम जरग', position: 'सदस्य', mobile: '9960131267' },
    { id: 9, name: 'निलेश पोपट सुतार', position: 'सदस्य', mobile: '7709086564' },
    { id: 10, name: 'गौरी राहुल पवार', position: 'सदस्य', mobile: '8169522418' },
    { id: 11, name: 'सुभाष वसंत उथळे', position: 'सदस्य', mobile: 'कार्यालय संपर्क' }
  ];
    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <section className="relative h-[60vh] md:h-[70vh] lg:h-[80vh] flex items-center justify-center text-center overflow-hidden">
        ...
        <Image
          ...
          alt="Rural agricultural setting for Gram Dakshata Committee"
          fill
      ...
      <div className="container mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8">
        ...
        <div className="mb-8 sm:mb-10 lg:mb-12 animate-slide-in-left delay-200">
          ...
          <div className="flex flex-row justify-center items-center gap-4 sm:gap-6 lg:gap-8 mb-4 sm:mb-6">
            {adhyaksh && (
              <div className="w-1/2 sm:w-1/2 lg:w-1/3 bg-white rounded-xl shadow-lg overflow-hidden text-center p-4 sm:p-6 border-t-4 border-orange-600 hover:shadow-2xl hover:scale-105 hover:-translate-y-2 transition-all duration-300 transform">
                <div className="bg-gradient-to-br from-orange-600 to-orange-800 text-white p-4 rounded-lg mb-4">
                  <div className="text-lg xs:text-xl sm:text-2xl font-bold mb-2 font-yatra-one">{adhyaksh.name}</div>
                  <div className="text-orange-100 text-base xs:text-lg sm:text-xl font-semibold">{adhyaksh.position}</div>
                </div>
            ...
            {sachiv && (
              <div className="w-1/2 sm:w-1/2 lg:w-1/3 bg-white rounded-xl shadow-lg overflow-hidden text-center p-4 sm:p-6 border-t-4 border-indigo-600 hover:shadow-2xl hover:scale-105 hover:-translate-y-2 transition-all duration-300 transform">
                <div className="bg-gradient-to-br from-indigo-600 to-indigo-800 text-white p-4 rounded-lg mb-4">
                  <div className="text-lg xs:text-xl sm:text-2xl font-bold mb-2 font-yatra-one">{sachiv.name}</div>
                  <div className="text-indigo-100 text-base xs:text-lg sm:text-xl font-semibold">{sachiv.position}</div>
                </div>
                <div className="text-gray-700 text-sm xs:text-base sm:text-lg font-bakbak-one">
...
export default GramDakshataPage;