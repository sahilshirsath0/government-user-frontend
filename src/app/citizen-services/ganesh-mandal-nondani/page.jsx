...
export default function GaneshMandalNondaniPage() {
  return (
    <div>
      {/* Page Header Section */}
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl md:text-5xl font-yatra-one font-bold bg-gradient-to-r from-blue-700 via-indigo-500 to-blue-700 bg-clip-text text-transparent animate-pulse transition-transform duration-700 hover:scale-[1.02]">Register Ganesh Mandal</h1>
            <h2 className="text-2xl md:text-4xl font-yatra-one font-bold text-slate-800 mt-2 transition-transform duration-700 hover:scale-[1.02]">(गणेश मंडळ नोंदणी)</h2>
